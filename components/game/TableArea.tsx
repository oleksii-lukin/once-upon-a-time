                ...
                <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 flex flex-col items-center gap-2 w-24 text-center pt-2">
                        {storytellerPlayer ? (
                            ...
                            <>
                                ...
                                <p className="font-bold text-white text-sm">Unknown</p>
                            </>
                        )}
                    ...
                    <div className="flex gap-2 p-2 rounded-lg bg-black/10 flex-wrap items-end">
                        {playedCards.map((card) => {
                            ...
                            const playerName = playedByPlayer ? getPlayerDisplayName(playedByPlayer) : 'Unknown';
                            ...
                            return (
                                <div key={card.id} className="w-32 flex flex-col gap-1 group relative">
                                    ...
                                    {playedByPlayer && (
                                        <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full overflow-hidden border border-white" title={`Played by ${playerName}`}>
